...
class PantryTest < Minitest::Test
  def setup
    ...
    recipe2 = Recipe.new('Pickles')
    recipe2.add_ingredient('Brine', 10)
    recipe2.add_ingredient('Cucumbers', 30)
    recipe3 = Recipe.new('Peanuts')
    recipe3.add_ingredient('Raw nuts', 10)
    recipe3.add_ingredient('Salt', 10)
    @pantry = Pantry.new
